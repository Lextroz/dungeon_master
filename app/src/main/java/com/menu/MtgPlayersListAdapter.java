...
public class MtgPlayersListAdapter extends BaseExpandableListAdapter {

    private Activity context;
    private ArrayList<Player> listGroup;

    public MtgPlayersListAdapter(Activity context, ArrayList<Player> listGroup) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
                convertView = inflater.inflate(R.layout.mtg_player_stats, null);
        }
